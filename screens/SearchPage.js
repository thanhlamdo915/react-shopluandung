...
const SearchPage = () => {
  ...
  const clearFilter = async () => {
    // Fetch the original search results based on the current searchQuery
    await fetchSearchResults(searchQuery); // Re-fetch results with the current search query
    setActiveFilter(null); // Reset the active filter
  };
      ...
      >
        <View style={styles.modalOverlay}>
          <View style={styles.modalContainer}>
            ...
            <Pressable
              onPress={() => {
                clearFilter(); // Clear any applied filters
                setModalVisible(false); // Hide the filter modal
              }}
            >
              <Text>Clear filter</Text>
            </Pressable>
            <Pressable
              style={styles.modalButton}
              onPress={() => {
                applyFilter('name'); // Example filter by name
                setModalVisible(false);
              }}
            >
              <Text>Name</Text>
            ...
            <Pressable
              style={styles.modalButton}
              onPress={() => {
                applyFilter('priceLowToHigh'); // Example filter by price low to high
                setModalVisible(false);
              }}
            >
              <Text>Price (low to high)</Text>
            ...
            <Pressable
              style={styles.modalButton}
              onPress={() => {
                applyFilter('priceHighToLow'); // Example filter by price high to low
                setModalVisible(false);
              }}
            >
              <Text>Price (high to low)</Text>
